...
### ---------------------------------------- ###
    ...
    call runspp.runspp {
        input:
            bamfile=select_first([mergebam_afterbklist, mapping.bklist_bam, mapping.sorted_bam]),
            control=select_first([c_mergebam_afterbklist, c_mapping.bklist_bam, c_mapping.sorted_bam])
    }
