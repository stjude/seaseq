...
### ---------------------------------------- ###
    ...
    call macs.macs {
        input :
            ...
            default_location = if defined(experiment_name) then experiment_name + '/PEAKS/NARROW_peaks/' + experiment_name + '-p9_kd-auto' else sub(basename(sample_bam),'\.sorted\.b.*$','') + '/PEAKS/NARROW_peaks/' + basename(sample_bam,'\.bam') + '-p9_kd-auto'
    }
    ...
    call macs.macs as all {
        input :
            ...
            default_location = if defined(experiment_name) then experiment_name + '/PEAKS/NARROW_peaks/' + experiment_name + '-p9_kd-all' else sub(basename(sample_bam),'\.sorted\.b.*$','') + '/PEAKS/NARROW_peaks/' + basename(sample_bam,'\.bam') + '-p9_kd-all'
    }
    ...
    call macs.macs as nomodel {
        input :
            ...
            default_location = if defined(experiment_name) then experiment_name + '/PEAKS/NARROW_peaks/' + experiment_name + '-nm' else sub(basename(sample_bam),'\.sorted\.b.*$','') + '/PEAKS/NARROW_peaks/' + basename(sample_bam,'\.bam') + '-nm'
    }
    ...
    call bamtogff.bamtogff {
        input :
            ...
            default_location=if defined(experiment_name) then experiment_name + '/BAM_Density' else sub(basename(sample_bam),'\.sorted\.b.*$','') + '/BAM_Density'
    }
    ...
    call sicer.sicer {
        input :
            ...
            default_location=if defined(experiment_name) then experiment_name + '/PEAKS/BROAD_peaks' else sub(basename(sample_bam),'\.sorted\.b.*$','') + '/PEAKS/BROAD_peaks'
    }
    ...
    call rose.rose {
        input :
            ...
            default_location=if defined(experiment_name) then experiment_name + '/PEAKS/STITCHED_peaks' else sub(basename(sample_bam),'\.sorted\.b.*$','') + '/PEAKS/STITCHED_peaks'
    }
    ...
    call viz.visualization as c_visualization {
        input:
            ...
            default_location=if defined(experiment_name) then experiment_name + '/COVERAGE_files/NARROW_peaks/' + sub(basename(macs.peakbedfile),'\_peaks.bed','') + '/control' else sub(basename(sample_bam),'\.sorted\.b.*$','') + '/COVERAGE_files/NARROW_peaks/' + sub(basename(macs.peakbedfile),'\_peaks.bed','') + '/control'
    }
    ...
    call viz.visualization as c_vizall {
        input:
            ...
            default_location=if defined(experiment_name) then experiment_name + '/COVERAGE_files/NARROW_peaks/' + sub(basename(all.peakbedfile),'\_peaks.bed','') + '/control' else sub(basename(sample_bam),'\.sorted\.b.*$','') + '/COVERAGE_files/NARROW_peaks/' + sub(basename(all.peakbedfile),'\_peaks.bed','') + '/control'
    }
    call viz.visualization as c_viznomodel {
        input:
            ...
            default_location=if defined(experiment_name) then experiment_name + '/COVERAGE_files/NARROW_peaks/' + sub(basename(nomodel.peakbedfile),'\_peaks.bed','') + '/control' else sub(basename(sample_bam),'\.sorted\.b.*$','') + '/COVERAGE_files/NARROW_peaks/' + sub(basename(nomodel.peakbedfile),'\_peaks.bed','') + '/control'
    }
    ...
    call util.peaksanno {
        input :
            ...
            default_location=if defined(experiment_name) then experiment_name + '/PEAKS_Annotation/NARROW_peaks/' + sub(basename(macs.peakbedfile),'\_peaks.bed','') else sub(basename(sample_bam),'\.sorted\.b.*$','') + '/PEAKS_Annotation/NARROW_peaks/' + sub(basename(macs.peakbedfile),'\_peaks.bed','')
    }
    ...
    call util.peaksanno as all_peaksanno {
        input :
            ...
            default_location=if defined(experiment_name) then experiment_name + '/PEAKS_Annotation/NARROW_peaks/' + sub(basename(all.peakbedfile),'\_peaks.bed','') else sub(basename(sample_bam),'\.sorted\.b.*$','') + '/PEAKS_Annotation/NARROW_peaks/' + sub(basename(all.peakbedfile),'\_peaks.bed','')
    }
    ...
    call util.peaksanno as nomodel_peaksanno {
        input :
            ...
            default_location=if defined(experiment_name) then experiment_name + '/PEAKS_Annotation/NARROW_peaks/' + sub(basename(nomodel.peakbedfile),'\_peaks.bed','') else sub(basename(sample_bam),'\.sorted\.b.*$','') + '/PEAKS_Annotation/NARROW_peaks/' + sub(basename(nomodel.peakbedfile),'\_peaks.bed','')
    }
    ...
    call util.peaksanno as sicer_peaksanno {
        input :
            ...
            chromsizes=samtools_faidx.chromsizes,
            default_location=if defined(experiment_name) then experiment_name + '/PEAKS_Annotation/BROAD_peaks' else sub(basename(sample_bam),'\.sorted\.b.*$','') + '/PEAKS_Annotation/BROAD_peaks'
    }
    ...
    call motifs.motifs {
        input:
            ...
            default_location=if defined(experiment_name) then experiment_name + '/MOTIFS' else sub(basename(sample_bam),'\.sorted\.b.*$','') + '/MOTIFS'
    }
    ...
    call viz.visualization {
        input:
            ...
            chromsizes=samtools_faidx.chromsizes,
            xlsfile=macs.peakxlsfile,
            default_location=if defined(experiment_name) then experiment_name + '/COVERAGE_files/NARROW_peaks/' + sub(basename(macs.peakbedfile),'\_peaks.bed','') else sub(basename(sample_bam),'\.sorted\.b.*$','') + '/COVERAGE_files/NARROW_peaks/' + sub(basename(macs.peakbedfile),'\_peaks.bed','')
    }
    ...
    call viz.visualization as vizall {
        input:
            ...
            chromsizes=samtools_faidx.chromsizes,
            xlsfile=all.peakxlsfile,
            default_location=if defined(experiment_name) then experiment_name + '/COVERAGE_files/NARROW_peaks/' + sub(basename(all.peakbedfile),'\_peaks.bed','') else sub(basename(sample_bam),'\.sorted\.b.*$','') + '/COVERAGE_files/NARROW_peaks/' + sub(basename(all.peakbedfile),'\_peaks.bed','')
    }
    ...
    call viz.visualization as viznomodel {
        input:
            ...
            chromsizes=samtools_faidx.chromsizes,
            xlsfile=nomodel.peakxlsfile,
            default_location=if defined(experiment_name) then experiment_name + '/COVERAGE_files/NARROW_peaks/' + sub(basename(nomodel.peakbedfile),'\_peaks.bed','') else sub(basename(sample_bam),'\.sorted\.b.*$','') + '/COVERAGE_files/NARROW_peaks/' + sub(basename(nomodel.peakbedfile),'\_peaks.bed','')
    }
    ...
    call viz.visualization as vizsicer {
        input:
            ...
            chromsizes=samtools_faidx.chromsizes,
            default_location=if defined(experiment_name) then experiment_name + '/COVERAGE_files/BROAD_peaks' else sub(basename(sample_bam),'\.sorted\.b.*$','') + '/COVERAGE_files/BROAD_peaks'
    }
...
### ---------------------------------------- ###
    ...
    call util.concatstats {
        ...
        input:
            ...
            default_location=if defined(experiment_name) then experiment_name + '/QC/SummaryStats' else sub(basename(sample_bam),'\.sorted\.b.*$','') + '/QC/SummaryStats'
    }
